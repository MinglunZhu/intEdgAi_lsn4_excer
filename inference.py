...
class Network:
    ...
    def load_model(self, model, device="CPU", cpu_extension=None):
        ...
        self.exec_network = self.plugin.load_network(self.network, device, num_requests = 201)
    ...
    def async_inference(self, rqsId, image):
        ...
        self.infer_request = self.exec_network.start_async(rqsId, {self.input_blob: image})
